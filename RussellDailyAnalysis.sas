...
/* Import CSV file */
proc import datafile='/home/u63744942/sasuser.v94/finalproject/Russell2000 Daily Returns.csv'
            out=russell2000
            dbms=csv replace;
run;
...
data _null_;
    set russell2000;
    file '/home/u63744942/sasuser.v94/finalproject/Russell2000 Daily Returns.sas7bdat';
    put _all_;
run;
...
*******************************************************************;
proc rank data=russell out=stock_size_ranks groups=10 ties=mean;
  var market_cap;
  ranks comp_size;
run;
...
data stock_size;
  ...
  if comp_size = 0 then percentile = 'Smallest';
  else if comp_size = 1 then percentile = '10-20%';
  else if comp_size = 2 then percentile = '20-30%';
  else if comp_size = 3 then percentile = '30-40%';
  else if comp_size = 4 then percentile = '40-50%';
  else if comp_size = 5 then percentile = '50-60%';
  else if comp_size = 6 then percentile = '60-70%';
  else if comp_size = 7 then percentile = '70-80%';
  else if comp_size = 8 then percentile = '80-90%';
  else percentile = 'Largest';
run;
